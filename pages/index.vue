...
const colors = [
    { name: 'red', class: 'bg-red-600', selectedClass: 'ring-gray-500', image: "/images/REGENT_Trung thu 2023_Charm.5.png" },
...
const canhColors = [
    { name: 'red', class: 'bg-red-600', selectedClass: 'ring-gray-500', image: "/images/REGENT_Trung thu 2023_Charm.23.png" },
...
const nhuyColors = [
    { name: 'red', class: 'bg-red-600', selectedClass: 'ring-gray-500', image: "/images/REGENT_Trung thu 2023_Charm.24.png" },
    ...
    <v-toolbar color="transparent" class="px-0">
      ...
      <v-window v-model="tab">
        ...
        <v-window-item value="two">
          <items
            v-model="selectedCanhColor"
            :colors="canhColors"
          />
        </v-window-item>
        <v-window-item value="three">
          <items
            v-model="selectedNhuyColor"
            :colors="nhuyColors"
          />
        </v-window-item>
